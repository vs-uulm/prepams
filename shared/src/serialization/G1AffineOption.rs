...
pub fn serialize<S: Serializer>(p: &Option<G1Affine>, serializer: S) -> Result<S::Ok, S::Error> {
    match p {
...
pub fn deserialize<'de, D: Deserializer<'de>>(deserializer: D) -> Result<Option<G1Affine>, D::Error> {
